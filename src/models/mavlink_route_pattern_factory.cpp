...
RoutePattern* MavlinkRoutePatternFactory::create(const QString& routePatternId)
{
    if (routePatternId == route::surveyPatternGrid.id)
        return new MavlinkRoutePattern(&route::surveyPatternGrid, new RoutePatternAlgorithmGrid());
    else if (routePatternId == route::surveyPatternSnail.id)
        return new MavlinkRoutePattern(&route::surveyPatternSnail, new RoutePatternAlgorithmSnail());
